...
class RemoteControlCommand extends EnigmaCommand<IRemoteControlCommand, IResponse<IRemoteControlCommand>>
    implements IRemoteControlCommand {
  final IResponseParser<IRemoteControlCommand, IResponse<IRemoteControlCommand>> parser;
